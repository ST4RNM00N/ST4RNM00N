...
<body>
    <div class="main">
        <table>
            ...
            <tr>
                <td class="info">
                 <p>hi, refer to me as X or star (preferbly x, but not the twitter/hj)<br>
                    multifandom, you can see which fandoms im in by seeing the gifs beloww<br>
                    (let me know what media/fandom ur in, and i'll let u know if i fw with it!)</p>
